...
- **WebSocket 打印：** 通过 WebSocket 服务器实时打印布局，无需用户交互。推荐工具：webapp-hardware-bridge，地址：https://github.com/imTigger/webapp-hardware-bridge/releases/tag/1.0.1
- **弹窗打印：** 在弹窗中生成预览以供手动打印。
